...
enum ParakeetClipPreparer {
    ...
    // FluidAudio works most reliably when the final chunk reaches this window.
    ...
    static func ensureMinimumDuration(
        ...
        logger: Logger = Logger(subsystem: "com.swair.hearsay", category: "parakeet")
        ...
        guard
            ...
            throw PreparationError.bufferAllocationFailed
        }
